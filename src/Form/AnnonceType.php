...
class AnnonceType extends ApplicationType
{
    ...
    {
        $builder
            ->add('title', TextType::class, $this->getConfiguration ("Titre de votre annonce", "Renseignez ici le titre de votre annonce (requis)"))
            ->add('slug', HiddenType::class)
            ->add(
                'birthDay', 
                IntegerType::class, 
                $this->getConfiguration ("Jour de naissance", "Jour",[
                    'attr' => [
                        'min' => 1, 
                        'max' => 31
                    ]
            ...
            ->add(
                'birthMonth', 
                IntegerType::class, 
                $this->getConfiguration("Mois de naissance", "Mois",[
                    'attr' => [
                        'min' => 1, 
                        'max' => 12 
                    ]
            ...
            ->add('birthYear', IntegerType::class, $this->getConfiguration ("Année de naissance*", "Année",
            ['attr' => [
                'min' => 1900, 
                'max' => 2019 
                    ]
            ...
            ->add('kind', ChoiceType::class, array(
                'label' => false,
                'required' => false,                
                'placeholder' => 'Sexe de l\'enfant (requis) :',
                'choices'  => array(
                    'Féminin' => 'Féminin',
                    'Masculin' => 'Masculin',
                    'Inconnu' => 'Inconnu')
            ...
            ->add('content', TextareaType::class, $this->getConfiguration ("Votre annonce*", "Détaillez votre recherche (requis)"));
    }
